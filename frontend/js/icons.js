// Lucide-style inline SVG icon set. Stroke-based, 24x24, currentColor.
// Replace all emoji everywhere with SVGs via data-lucide attribute.
(function(){
  const ICONS = {
    'globe-2': '<circle cx="12" cy="12" r="10"/><path d="M21.54 15H17a2 2 0 0 0-2 2v4.54"/><path d="M7 3.34V5a3 3 0 0 0 3 3v0a2 2 0 0 1 2 2v0c0 1.1.9 2 2 2v0a2 2 0 0 0 2-2v0c0-1.1.9-2 2-2h3.17"/><path d="M11 21.95V18a2 2 0 0 0-2-2v0a2 2 0 0 1-2-2v-1a2 2 0 0 0-2-2H2.05"/>',
  ...
  function injectIcons() {
    document.querySelectorAll('[data-lucide]').forEach(el => {
      ...
      if (!path) return;
      el.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round">${path}</svg>`;
    });
  }
  window.injectIcons = injectIcons;
  window.lucide = (name) => {
    const path = ICONS[name] || '';
    return `<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round">${path}</svg>`;
  };
})();
