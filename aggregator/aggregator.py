...
# Keys come from the environment only. Hardcoded fallback values were
# scrubbed 2026-08-01 — this file is dead code (.dockerignored, superseded
# by the worldtwin/ package) but was world-readable with live keys inline.
