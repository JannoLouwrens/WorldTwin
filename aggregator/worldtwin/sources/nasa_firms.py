...
LAYER = LayerMeta(
    ...
    refresh_s=3600,  # FIRMS global NRT is ~3 h latent — 10-min polling cannot surface newer data
    initial_delay_s=6,
    max_bytes=6_000_000,  # legitimately >2 MB at steady state (why the render slice exists)
